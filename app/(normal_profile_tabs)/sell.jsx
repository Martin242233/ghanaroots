...
const UploadItemScreen = () => {
  ...
  const handleSellItem = () => {
    if(selectedImage === '' || description ===  '' || quantity === "" || price === "" ) {
      alert('Please your item informations are missing or invalid')
    }else{
      console.log(selectedImage);
      router.push({ pathname: 'recapitulatif_sell/[sell_recap_screen]', params: { item_desc: description, item_id: quantity, item_title: title, item_price: price, item_image_url: selectedImage } })
    }
  };
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#ffffff', marginTop: Platform.OS === 'android' ? '10%' : 'none' }}>
      <ScrollView>
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.confirmButton} onPress={handleSellItem}
          >
